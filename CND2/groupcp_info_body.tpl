...
<table cellspacing="1" class="groupcp">
	...
	<tr>
		<td colspan="5" class="secondline">
			...
			{SITENAME}&nbsp;&nbsp;&raquo;&nbsp;&nbsp;{L_GROUP_INFORMATION}</td>
	</tr>
	<tr> 
		<td colspan="5"><h2>{GROUP_NAME}</td>
	</tr>
	<tr> 
...
<table cellspacing="1" class="groupcp">
	...
	<!-- BEGIN switch_mod_option -->
	<tr>
		<td class="row1 pad4 txtright" colspan="7"><input type="submit" name="remove" value="{L_REMOVE_SELECTED}" class="button" /></td>
	</tr>
	<!-- END switch_mod_option -->
	{PENDING_USER_BOX}
	<tr> 
		<td class="row3" style="padding: 0" colspan="7"><table cellspacing="0">
			<tr>
				...
				<td class="darkCornerR pad4 txtright">&nbsp;
				<!-- BEGIN switch_mod_option -->
				<input type="text"  class="post postmedium" name="username" maxlength="50" />&nbsp;<input type="submit" name="add" value="{L_ADD_MEMBER}" class="button" />&nbsp;<input type="submit" name="usersubmit" value="{L_FIND_USERNAME}" class="button" onclick="window.open('{U_SEARCH_USER}', '_phpbbsearch', 'HEIGHT=250,resizable=yes,WIDTH=400');return false;" />
				<!-- END switch_mod_option -->
				</td>
			</tr>
		</table></td>	
