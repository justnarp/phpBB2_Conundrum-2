...
<table cellspacing="1" class="index_body">
	...
	<tr> 
		<td class="row1 one lightCornerL" rowspan="2"><img src="templates/CND2/images/whosonline.gif" alt="" /></td>
...
<table cellspacing="1" class="index_body_icons">
	<tr> 
		<td><img src="templates/CND2/images/folder_new_big.gif" alt=""/>
		{L_NEW_POSTS}&nbsp;&nbsp;
		<img src="templates/CND2/images/folder_locked_big.gif" alt="" />
		{L_FORUM_LOCKED}&nbsp;&nbsp;&nbsp;&nbsp;</td>
	</tr>
</table>