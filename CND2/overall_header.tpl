<!--
	The original CND2 v2.4 skin for phpBB version 2+
...
<link rel="icon"
	href="templates/CND2/images/favicon.ico" />

<link rel="stylesheet"
	href="templates/CND2/CND2.css" type="text/css" />

<script type="text/javascript"
	src="templates/CND2/CND2.js"></script>

<script type="text/javascript" 
	src="templates/CND2/overlib.js"></script>
...
<table cellspacing="0" id="forum">
	<tr>
		...
		<div id="top_image">
			<a href="{U_INDEX}"><img src="templates/CND2/images/top_image.jpg" alt="{L_INDEX}" /></a>
		</div>
